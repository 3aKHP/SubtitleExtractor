...
This project calls [ffmpeg](https://ffmpeg.org/) as an external process (GPL v2+) and bundles [yt-dlp](https://github.com/yt-dlp/yt-dlp) (Unlicense). See [LICENSE](LICENSE) for details.
